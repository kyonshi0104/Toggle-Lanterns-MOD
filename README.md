...
- **State Preservation**: The unlit lantern perfectly keeps the original state, including whether it is hanging from the ceiling or waterlogged.
...
- **状態の維持**: 天井からの吊り下げ状態や、水没状態など、元のランタンの設置状態をそのまま引き継ぎます。
...
- **Minecraft Version**: 1.20 - 1.20.6
- **License**: [MIT](LICENSE)
- **Developed by**: kyonshi ([kyonshi.com](https://kyonshi.com))

## Dependencies (前提Mod)
- [Fabric API](https://modrinth.com/mod/fabric-api) : Required for the mod to function.
